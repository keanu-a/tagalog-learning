module.exports.dataPhrase = [
  ...
  //   hint: 'Ilan means "How many" in English',
  // },
  // {
  //   tagalog: 'Anong pangalan mo?',
  //   english: 'What is your name?',
  //   hint: 'Pangalan means "name" in English',
  // },
  // {
  //   tagalog: '(Name) ako',
  //   english: "I'm (Name)",
  ...
  //   english: 'You are not paying attention to my feelings.',
  //   hint: 'Pinapansin - to pay attention',
  // },
  // {
  //   tagalog: 'Galit ka ba?',
  //   english: 'Are you mad?',
  ...
  //   english: 'Wash the dishes in the sink',
  // },
  // {
  ...
  //   english: 'I dont like my coworkers.',
  // },
  // {
